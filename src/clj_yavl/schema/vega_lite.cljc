...
(def schema
 ...
 [:map
  ...
  [:y2
   {:optional true}
   [:or number? [:ref "ExprRef"] [:enum "height"]]]
 ...
 [:or
  [:ref "ScaleInvalidDataShowAsValue<\"x\">"]
  [:enum "zero-or-min"]],
 ...
 [:or
  [:ref "ScaleInvalidDataShowAsValue<\"y\">"]
  [:enum "zero-or-min"]],
 "Scale"
 [:map
  {:closed true}
  ...
  [:range
   ...
   [:or
    ...
    [:ref "FieldRange"]
    [:vector
     [:or number? string? [:vector number?] [:ref "ExprRef"]]]]]
 ...
 [:enum
  ...
  "touchstart"
  "wheel"],
 "LabelOverlap" [:or boolean? [:enum "parity" "greedy"]],
 "LogicalOr<Predicate>"
 ...
 [:map
  ...
  [:spacing {:optional true} [:or number? [:ref "RowCol<number>"]]]
  [:data {:optional true} [:or [:ref "Data"] nil?]]],
 "ConditionalAxisColor" [:ref "ConditionalAxisProperty<(Color|null)>"],
 ...
 [:ref "ValueDefWithCondition<MarkPropFieldOrDatumDef,(string|null)>"],
 ...
 "LegendBinding" [:or [:ref "LegendStreamBinding"] [:enum "legend"]],
