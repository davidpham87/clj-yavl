...
(def ConditionalAxisLabelFontStyle
  [:ref
   #:json-schema{:original-name "ConditionalAxisProperty<(FontStyle|null)>"}
  ...
  [:map {:closed true} [:y {:optional true} [:ref #'PositionDef]]
   ...
   [:xError2 {:optional true}
    [:or [:ref #'SecondaryFieldDef]
     [:ref #:json-schema{:original-name "ValueDef<number>"}
      #'ValueDef_number_]]] [:stroke {:optional true} [:ref #'ColorDef]]
   ...
   [:yError2 {:optional true}
    [:or [:ref #'SecondaryFieldDef]
     [:ref #:json-schema{:original-name "ValueDef<number>"}
      #'ValueDef_number_]]] [:yOffset {:optional true} [:ref #'OffsetDef]]
...
(def ScaleInvalidDataConfig
  [:map {:closed true}
   ...
   [:fillOpacity {:optional true}
    [:ref
     #:json-schema{:original-name "ScaleInvalidDataShowAs<\"fillOpacity\">"}
   ...
   [:strokeWidth {:optional true}
    [:ref
     #:json-schema{:original-name "ScaleInvalidDataShowAs<\"strokeWidth\">"}
...
(def SelectionInitInterval
  [:or
   [:ref #:json-schema{:original-name "Vector2<boolean>"} #'Vector2_boolean_]
   [:ref #:json-schema{:original-name "Vector2<number>"} #'Vector2_number_]
   [:ref #:json-schema{:original-name "Vector2<string>"} #'Vector2_string_]
   [:ref #:json-schema{:original-name "Vector2<DateTime>"}
    #'Vector2_DateTime_]])
