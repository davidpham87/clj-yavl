...
return console.error("Vega Embed Error (mount):",err);
}));
} else {
return null;
}
...
return console.error("Vega Embed Error (update):",err);
}));
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-full h-full overflow-auto p-4",new cljs.core.Keyword(null,"ref","ref",1289896967),(function (p1__29675_SHARP_){
return cljs.core.reset_BANG_(container_ref,p1__29675_SHARP_);
})], null)], null);
})], null));
});

//# sourceMappingURL=clj_yavl.webapp.viz.js.map
