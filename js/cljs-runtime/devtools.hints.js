...
var map__22484 = top_item;
var map__22484__$1 = cljs.core.__destructure_map(map__22484);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22484__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22484__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22484__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e22481){var _e = e22481;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5823__auto___22517 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5823__auto___22517)){
var seen_errors_22518 = temp__5823__auto___22517;
if(cljs.core.truth_(seen_errors_22518.has(self))){
} else {
seen_errors_22518.add(self);

var temp__5825__auto___22519 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5825__auto___22519)){
var sense_22520 = temp__5825__auto___22519;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_22520)].join(''));
} else {
}
}
} else {
