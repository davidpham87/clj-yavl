...
if(cljs.core.truth_((function (){var fexpr__26625 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 9, [new cljs.core.Keyword(null,"double","double",884886883),null,new cljs.core.Symbol(null,"int?","int?",1799729645,null),null,new cljs.core.Keyword(null,"int","int",-1741416922),null,new cljs.core.Keyword(null,"number","number",1570378438),null,new cljs.core.Symbol(null,"float?","float?",673884616,null),null,new cljs.core.Keyword(null,"float","float",-1732389368),null,new cljs.core.Symbol(null,"integer?","integer?",1303791671,null),null,new cljs.core.Symbol(null,"number?","number?",-1747282210,null),null,new cljs.core.Symbol(null,"double?","double?",-2146564276,null),null], null), null);
return (fexpr__26625.cljs$core$IFn$_invoke$arity$1 ? fexpr__26625.cljs$core$IFn$_invoke$arity$1(t) : fexpr__26625.call(null,t));
})())){
return "quantitative";
} else {
if(cljs.core.truth_((function (){var fexpr__26626 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"string","string",-1989541586),null,new cljs.core.Symbol(null,"string?","string?",-1129175764,null),null], null), null);
return (fexpr__26626.cljs$core$IFn$_invoke$arity$1 ? fexpr__26626.cljs$core$IFn$_invoke$arity$1(t) : fexpr__26626.call(null,t));
})())){
return "nominal";
} else {
if(cljs.core.truth_((function (){var fexpr__26627 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"boolean?","boolean?",1790940868,null),null,new cljs.core.Keyword(null,"boolean","boolean",-1919418404),null], null), null);
return (fexpr__26627.cljs$core$IFn$_invoke$arity$1 ? fexpr__26627.cljs$core$IFn$_invoke$arity$1(t) : fexpr__26627.call(null,t));
})())){
return "nominal";
} else {
...
return (fexpr__26628.cljs$core$IFn$_invoke$arity$1 ? fexpr__26628.cljs$core$IFn$_invoke$arity$1(t) : fexpr__26628.call(null,t));
})())){
return "temporal";
} else {
...
return cljs.core.some((function (p__26630){
var vec__26631 = p__26630;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26631,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26631,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26631,(2),null);
...
var expression = clojure.string.join.cljs$core$IFn$_invoke$arity$2(" : ",cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__26634){
var vec__26635 = p__26634;
var old = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26635,(0),null);
var new$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26635,(1),null);
return ["datum['",cljs.core.str.cljs$core$IFn$_invoke$arity$1(col_name),"'] == '",cljs.core.str.cljs$core$IFn$_invoke$arity$1(old),"' ? '",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new$),"'"].join('');
...
return cljs.core.vec((function (){var iter__5503__auto__ = (function clj_yavl$api$tooltip_def_$_iter__26638(s__26639){
return (new cljs.core.LazySeq(null,(function (){
var s__26639__$1 = s__26639;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__26639__$1);
if(temp__5825__auto__){
var s__26639__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26639__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__26639__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__26641 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__26640 = (0);
while(true){
if((i__26640 < size__5502__auto__)){
var k = cljs.core._nth(c__5501__auto__,i__26640);
cljs.core.chunk_append(b__26641,(function (){var inferred_type = clj_yavl.api.infer_type_for_field(dataset_schema,k);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26641),clj_yavl$api$tooltip_def_$_iter__26638(cljs.core.chunk_rest(s__26639__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26641),null);
}
} else {
var k = cljs.core.first(s__26639__$2);
...
})(),clj_yavl$api$tooltip_def_$_iter__26638(cljs.core.rest(s__26639__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(clj_yavl.api.deep_merge.cljs$lang$applyTo = (function (seq26642){
