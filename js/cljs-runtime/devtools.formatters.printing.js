...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25388){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25400_SHARP_){
return (!((cljs.core.meta(p1__25400_SHARP_) == null)));
})))){
...
var map__25402 = opts;
var map__25402__$1 = cljs.core.__destructure_map(map__25402);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25402__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25403){var _e__22340__auto__ = e25403;
return false;
}})();
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
...
}catch (e25405){var _e__22340__auto__ = e25405;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__25407 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25408 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25408);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25412__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25407);
}});
...
var temp__5823__auto___25452 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5823__auto___25452)){
var managed_print_level_25453 = temp__5823__auto___25452;
var _STAR_print_level_STAR__orig_val__25414_25454 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25415_25455 = managed_print_level_25453;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__25415_25455);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__25413_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__25413_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25414_25454);
}} else {
job_fn();
}
