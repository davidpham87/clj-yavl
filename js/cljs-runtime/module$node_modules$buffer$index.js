shadow$provide.module$node_modules$buffer$index = function(require, module, exports, global) {
  ...
  function createBuffer(that, length) {
    ...
    Buffer.TYPED_ARRAY_SUPPORT ? (that = new Uint8Array(length), that.__proto__ = Buffer.prototype) : (that === null && (that = new Buffer(length)), that.length = length);
    return that;
  }
  ...
  function from(that, value, encodingOrOffset, length) {
    ...
    if (typeof ArrayBuffer !== "undefined" && value instanceof ArrayBuffer) {
      ...
      value = encodingOrOffset === void 0 && length === void 0 ? new Uint8Array(value) : length === void 0 ? new Uint8Array(value, encodingOrOffset) : new Uint8Array(value, encodingOrOffset, length);
  ...
  function fromObject(that, obj) {
    ...
    if (obj) {
      if (typeof ArrayBuffer !== "undefined" && obj.buffer instanceof ArrayBuffer || "length" in obj) {
        return (len = typeof obj.length !== "number") || (len = obj.length, len = len !== len), len ? createBuffer(that, 0) : fromArrayLike(that, obj);
      }
      ...
      switch(encoding) {
        case "hex":
          ...
          for (start = ""; encoding < end; ++encoding) {
            loweredCase = this[encoding], loweredCase = loweredCase < 16 ? "0" + loweredCase.toString(16) : loweredCase.toString(16), start += loweredCase;
          }
          return start;
        case "utf8":
        case "utf-8":
        ...
        case "utf-16le":
          ...
          encoding = "";
          for (start = 0; start < end.length; start += 2) {
  ...
  function bidirectionalIndexOf(buffer, val, byteOffset, encoding, dir) {
    ...
    if (typeof val === "number") {
      return val &= 255, Buffer.TYPED_ARRAY_SUPPORT && typeof Uint8Array.prototype.indexOf === "function" ? dir ? Uint8Array.prototype.indexOf.call(buffer, val, byteOffset) : Uint8Array.prototype.lastIndexOf.call(buffer, val, byteOffset) : arrayIndexOf(buffer, [val], byteOffset, encoding, dir);
    }
  ...
  function utf8Slice(buf, start, end) {
    ...
    for (var res = []; start < end;) {
      var firstByte = buf[start], codePoint = null, bytesPerSequence = firstByte > 239 ? 4 : firstByte > 223 ? 3 : firstByte > 191 ? 2 : 1;
      if (start + bytesPerSequence <= end) {
        switch(bytesPerSequence) {
          ...
          case 4:
            ...
            (secondByte & 192) === 128 && (thirdByte & 192) === 128 && (fourthByte & 192) === 128 && (firstByte = (firstByte & 15) << 18 | (secondByte & 63) << 12 | (thirdByte & 63) << 6 | fourthByte & 63, firstByte > 65535 && firstByte < 1114112 && (codePoint = firstByte));
        }
      }
  ...
  Buffer.TYPED_ARRAY_SUPPORT && (Buffer.prototype.__proto__ = Uint8Array.prototype, Buffer.__proto__ = Uint8Array, typeof Symbol !== "undefined" && Symbol.species && Buffer[Symbol.species] === Buffer && Object.defineProperty(Buffer, Symbol.species, {value:null, configurable:!0}));
  Buffer.alloc = function(size, fill, encoding) {
    assertSize(size);
    size = size <= 0 ? createBuffer(null, size) : fill !== void 0 ? typeof encoding === "string" ? createBuffer(null, size).fill(fill, encoding) : createBuffer(null, size).fill(fill) : createBuffer(null, size);
    return size;
  };
  ...
  Buffer.prototype.inspect = function() {
    ...
    this.length > 0 && (str = this.toString("hex", 0, max).match(/.{2}/g).join(" "), this.length > max && (str += " ... "));
    ...
    for (remaining = !1;;) {
      switch(encoding) {
        ...
        case "utf-16le":
          ...
          for (var byteArray = [], i = 0; i < encoding.length && !((remaining -= 2) < 0); ++i) {
  ...
  Buffer.prototype.readUIntBE = function(offset, byteLength, noAssert) {
    ...
    for (var mul = 1; byteLength > 0 && (mul *= 256);) {
  ...
  Buffer.prototype.readIntBE = function(offset, byteLength, noAssert) {
    ...
    noAssert || checkOffset(offset, byteLength, this.length);
    noAssert = byteLength;
    for (var mul = 1, val = this[offset + --noAssert]; noAssert > 0 && (mul *= 256);) {
