...
var G__31252 = db;
var G__31252__$1 = ((cljs.core.not(user_input_exists_QMARK_))?cljs.core.assoc_in(G__31252,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770)], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"saved-configs","saved-configs",1634320315),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword("clj-yavl.core","data-input","clj-yavl.core/data-input",611355071),"",new cljs.core.Keyword("clj-yavl.core","config-input","clj-yavl.core/config-input",1110176655),clj_yavl.events.default_config_json,new cljs.core.Keyword("clj-yavl.core","config-mode","clj-yavl.core/config-mode",-1919291340),new cljs.core.Keyword(null,"json","json",1279968570),new cljs.core.Keyword("clj-yavl.core","active-config-name","clj-yavl.core/active-config-name",-1939900428),null,new cljs.core.Keyword("clj-yavl.core","ds-db","clj-yavl.core/ds-db",-1126598866),ds_db], null)], null)):G__31252);
var G__31252__$2 = ((cljs.core.not(component_state_exists_QMARK_))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31252__$1,new cljs.core.Keyword("clj-yavl.core","vega-lite","clj-yavl.core/vega-lite",943809627),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword("clj-yavl.core","format","clj-yavl.core/format",1360929541),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword("clj-yavl.core","structure","clj-yavl.core/structure",-30773006),new cljs.core.Keyword(null,"columnar","columnar",-1122999701),new cljs.core.Keyword("clj-yavl.core","parsed-data","clj-yavl.core/parsed-data",-1560578265),null,new cljs.core.Keyword("clj-yavl.core","inferred-schema","clj-yavl.core/inferred-schema",-1109150020),null,new cljs.core.Keyword("clj-yavl.core","active-left-tab","clj-yavl.core/active-left-tab",1685289502),new cljs.core.Keyword(null,"config","config",994861415)], null)):G__31252__$1);
if(cljs.core.not(unit_specs_exists_QMARK_)){
return cljs.core.assoc_in(G__31252__$2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"unit-specs","unit-specs",-530655085)], null),cljs.core.PersistentArrayMap.EMPTY);
} else {
return G__31252__$2;
}
});
clj_yavl.events.init_unit_spec = (function clj_yavl$events$init_unit_spec(db,p__31259){
var vec__31260 = p__31259;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31260,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31260,(1),null);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31260,(2),null);
var initial_input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31260,(3),null);
...
clj_yavl.events.remove_unit_spec = (function clj_yavl$events$remove_unit_spec(db,p__31263){
var vec__31264 = p__31263;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31264,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31264,(1),null);
...
clj_yavl.events.update_unit_spec_input = (function clj_yavl$events$update_unit_spec_input(db,p__31272){
var vec__31277 = p__31272;
...
var _STAR_print_newline_STAR__orig_val__31295_31373 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__31296_31374 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__31297_31375 = true;
var _STAR_print_fn_STAR__temp_val__31298_31376 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__31297_31375);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__31298_31376);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(edn_data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__31296_31374);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__31295_31373);
}
...
clj_yavl.events.set_top_level_prop = (function clj_yavl$events$set_top_level_prop(db,p__31302){
var vec__31303 = p__31302;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31303,(0),null);
var prop_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31303,(1),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31303,(2),null);
var user_input = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328)], null));
...
var _STAR_print_newline_STAR__orig_val__31307_31377 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__31308_31378 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__31309_31379 = true;
var _STAR_print_fn_STAR__temp_val__31310_31380 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__31309_31379);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__31310_31380);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(updated);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__31308_31378);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__31307_31377);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})());
...
var _STAR_print_newline_STAR__orig_val__31311_31381 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__31312_31382 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__31313_31383 = true;
var _STAR_print_fn_STAR__temp_val__31314_31384 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__31313_31383);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__31314_31384);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(config);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__31312_31382);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__31311_31381);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})());
...
clj_yavl.events.update_mark = (function clj_yavl$events$update_mark(db,p__31315){
var vec__31316 = p__31315;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31316,(0),null);
var mark_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31316,(1),null);
var ds_db = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("clj-yavl.core","ds-db","clj-yavl.core/ds-db",-1126598866)], null));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.events","set-dataset-url-input","clj-yavl.events/set-dataset-url-input",-1979763890),(function (db,p__31326){
var vec__31327 = p__31326;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31327,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31327,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.events","fetch-dataset","clj-yavl.events/fetch-dataset",-896793732),(function (p__31331,p__31332){
var map__31333 = p__31331;
var map__31333__$1 = cljs.core.__destructure_map(map__31333);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31333__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__31334 = p__31332;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31334,(0),null);
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31334,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.events","fetch-dataset-success","clj-yavl.events/fetch-dataset-success",1402343088),(function (db,p__31341){
var vec__31346 = p__31341;
...
var _STAR_print_newline_STAR__orig_val__31350_31385 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__31351_31386 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__31352_31387 = true;
var _STAR_print_fn_STAR__temp_val__31353_31388 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__31352_31387);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__31353_31388);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(updated);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__31351_31386);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__31350_31385);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})()):null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.events","fetch-dataset-failure","clj-yavl.events/fetch-dataset-failure",-962316695),(function (db,p__31354){
var vec__31355 = p__31354;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31355,(0),null);
var err = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31355,(1),null);
console.error("Failed to fetch dataset:",err);

return db;
}));
re_frame.core.reg_fx(new cljs.core.Keyword("promise","fetch","promise/fetch",-566993641),(function (p__31358){
var map__31359 = p__31358;
var map__31359__$1 = cljs.core.__destructure_map(map__31359);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31359__$1,new cljs.core.Keyword(null,"url","url",276297046));
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31359__$1,new cljs.core.Keyword(null,"on-success","on-success",1786904109));
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31359__$1,new cljs.core.Keyword(null,"on-failure","on-failure",842888245));
...
clj_yavl.events.update_channel_field = (function clj_yavl$events$update_channel_field(db,p__31365){
var vec__31366 = p__31365;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31366,(0),null);
var channel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31366,(1),null);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31366,(2),null);
var ds_db = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("clj-yavl.core","ds-db","clj-yavl.core/ds-db",-1126598866)], null));
...
clj_yavl.events.update_tooltip = (function clj_yavl$events$update_tooltip(db,p__31369){
var vec__31370 = p__31369;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31370,(0),null);
var tooltip_def = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31370,(1),null);
var ds_db = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("clj-yavl.core","ds-db","clj-yavl.core/ds-db",-1126598866)], null));
