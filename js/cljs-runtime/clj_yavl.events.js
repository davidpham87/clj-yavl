...
clj_yavl.events.remove_unit_spec = (function clj_yavl$events$remove_unit_spec(db,p__31271){
var vec__31272 = p__31271;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31272,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31272,(1),null);
...
clj_yavl.events.update_unit_spec_input = (function clj_yavl$events$update_unit_spec_input(db,p__31275){
var vec__31276 = p__31275;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31276,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31276,(1),null);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31276,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31276,(3),null);
...
clj_yavl.events.set_unit_spec_input = (function clj_yavl$events$set_unit_spec_input(db,p__31279){
var vec__31280 = p__31279;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31280,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31280,(1),null);
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31280,(2),null);
...
clj_yavl.events.set_config_input = (function clj_yavl$events$set_config_input(db,p__31283){
var vec__31284 = p__31283;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31284,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31284,(1),null);
...
}catch (e31287){var ___$1 = e31287;
return null;
}})();
var G__31288 = cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("clj-yavl.core","config-input","clj-yavl.core/config-input",1110176655)], null),val);
if(cljs.core.truth_(parsed)){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__31288,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("clj-yavl.core","ds-db","clj-yavl.core/ds-db",-1126598866)], null),(function (old_db){
...
clj_yavl.events.set_config_mode = (function clj_yavl$events$set_config_mode(db,p__31289){
var vec__31290 = p__31289;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31290,(0),null);
var new_mode = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31290,(1),null);
...
var _STAR_print_newline_STAR__orig_val__31294_31350 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__31295_31351 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__31296_31352 = true;
var _STAR_print_fn_STAR__temp_val__31297_31353 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__31296_31352);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__31297_31353);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(edn_data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__31295_31351);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__31294_31350);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
}catch (e31293){var ___$1 = e31293;
...
clj_yavl.events.set_top_level_prop = (function clj_yavl$events$set_top_level_prop(db,p__31299){
var vec__31300 = p__31299;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31300,(0),null);
var prop_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31300,(1),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31300,(2),null);
var user_input = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328)], null));
...
var _STAR_print_newline_STAR__orig_val__31304_31354 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__31305_31355 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__31306_31356 = true;
var _STAR_print_fn_STAR__temp_val__31307_31357 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__31306_31356);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__31307_31357);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(updated);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__31305_31355);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__31304_31354);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})());
...
var _STAR_print_newline_STAR__orig_val__31308_31358 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__31309_31359 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__31310_31360 = true;
var _STAR_print_fn_STAR__temp_val__31311_31361 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__31310_31360);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__31311_31361);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(config);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__31309_31359);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__31308_31358);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})());
...
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31328,(1),null);
var user_input = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328)], null));
var mode = new cljs.core.Keyword("clj-yavl.core","config-mode","clj-yavl.core/config-mode",-1919291340).cljs$core$IFn$_invoke$arity$1(user_input);
var input = new cljs.core.Keyword("clj-yavl.core","config-input","clj-yavl.core/config-input",1110176655).cljs$core$IFn$_invoke$arity$1(user_input);
var parsed = (function (){try{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mode,new cljs.core.Keyword(null,"json","json",1279968570))){
...
var _STAR_print_newline_STAR__orig_val__31332_31362 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__31333_31363 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__31334_31364 = true;
var _STAR_print_fn_STAR__temp_val__31335_31365 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__31334_31364);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__31335_31365);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(updated);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__31333_31363);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__31332_31362);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5670__auto__);
})()):null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.events","fetch-dataset-failure","clj-yavl.events/fetch-dataset-failure",-962316695),(function (db,p__31336){
var vec__31337 = p__31336;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31337,(0),null);
var err = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31337,(1),null);
console.error("Failed to fetch dataset:",err);

return db;
}));
re_frame.core.reg_fx(new cljs.core.Keyword("promise","fetch","promise/fetch",-566993641),(function (p__31340){
var map__31341 = p__31340;
var map__31341__$1 = cljs.core.__destructure_map(map__31341);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31341__$1,new cljs.core.Keyword(null,"url","url",276297046));
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31341__$1,new cljs.core.Keyword(null,"on-success","on-success",1786904109));
var on_failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31341__$1,new cljs.core.Keyword(null,"on-failure","on-failure",842888245));
...
clj_yavl.events.update_channel_field = (function clj_yavl$events$update_channel_field(db,p__31342){
var vec__31343 = p__31342;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31343,(0),null);
var channel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31343,(1),null);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31343,(2),null);
var ds_db = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("clj-yavl.core","ds-db","clj-yavl.core/ds-db",-1126598866)], null));
...
clj_yavl.events.update_tooltip = (function clj_yavl$events$update_tooltip(db,p__31346){
var vec__31347 = p__31346;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31347,(0),null);
var tooltip_def = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31347,(1),null);
var ds_db = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770),new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("clj-yavl.core","ds-db","clj-yavl.core/ds-db",-1126598866)], null));
