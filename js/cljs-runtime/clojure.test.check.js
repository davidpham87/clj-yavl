...
var vec__41621 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41621,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41621,(1),null);
...
var len__5749__auto___41761 = arguments.length;
var i__5750__auto___41762 = (0);
while(true){
if((i__5750__auto___41762 < len__5749__auto___41761)){
args__5755__auto__.push((arguments[i__5750__auto___41762]));

var G__41763 = (i__5750__auto___41762 + (1));
i__5750__auto___41762 = G__41763;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__41640){
var map__41641 = p__41640;
var map__41641__$1 = cljs.core.__destructure_map(map__41641);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41641__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41641__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__41641__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__41642 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41642,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41642,(1),null);
...
var vec__41675 = size_seq__$1;
var seq__41676 = cljs.core.seq(vec__41675);
var first__41677 = cljs.core.first(seq__41676);
var seq__41676__$1 = cljs.core.next(seq__41676);
var size = first__41677;
var rest_size_seq = seq__41676__$1;
var vec__41678 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41678,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41678,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq41627){
var G__41628 = cljs.core.first(seq41627);
var seq41627__$1 = cljs.core.next(seq41627);
var G__41629 = cljs.core.first(seq41627__$1);
var seq41627__$2 = cljs.core.next(seq41627__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41628,G__41629,seq41627__$2);
}));
...
var map__41685 = smallest;
var map__41685__$1 = cljs.core.__destructure_map(map__41685);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41685__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__41773 = tail;
var G__41774 = current_smallest;
var G__41775 = (total_nodes_visited + (1));
var G__41776 = depth;
nodes = G__41773;
current_smallest = G__41774;
total_nodes_visited = G__41775;
depth = G__41776;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__41744_41777 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__41744_41777) : reporter_fn.call(null,G__41744_41777));

var temp__5823__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5823__auto__){
var children = temp__5823__auto__;
var G__41778 = children;
var G__41779 = new_smallest;
var G__41780 = (total_nodes_visited + (1));
var G__41781 = (depth + (1));
nodes = G__41778;
current_smallest = G__41779;
total_nodes_visited = G__41780;
depth = G__41781;
continue;
} else {
var G__41782 = tail;
var G__41783 = new_smallest;
var G__41784 = (total_nodes_visited + (1));
var G__41785 = depth;
nodes = G__41782;
current_smallest = G__41783;
total_nodes_visited = G__41784;
depth = G__41785;
continue;
}
}
...
var G__41746_41786 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__41746_41786) : reporter_fn.call(null,G__41746_41786));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__41745_SHARP_){
var G__41747 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__41745_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__41747) : reporter_fn.call(null,G__41747));
}));
var G__41748_41787 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__41748_41787) : reporter_fn.call(null,G__41748_41787));
