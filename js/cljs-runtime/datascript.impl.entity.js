...
var G__27474 = db;
var G__27475 = e;
var G__27476 = cljs.core.volatile_BANG_(false);
var G__27477 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__27474,G__27475,G__27476,G__27477) : datascript.impl.entity.__GT_Entity.call(null,G__27474,G__27475,G__27476,G__27477));
} else {
return null;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__27482_SHARP_,p2__27483_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__27482_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__27483_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__27484_SHARP_,p2__27485_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__27484_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__27485_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__27493_SHARP_,p2__27494_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__27493_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__27494_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__5503__auto__ = (function datascript$impl$entity$js_seq_$_iter__27500(s__27501){
return (new cljs.core.LazySeq(null,(function (){
var s__27501__$1 = s__27501;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__27501__$1);
if(temp__5825__auto__){
var s__27501__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27501__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__27501__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__27503 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__27502 = (0);
while(true){
if((i__27502 < size__5502__auto__)){
var vec__27507 = cljs.core._nth(c__5501__auto__,i__27502);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27507,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27507,(1),null);
cljs.core.chunk_append(b__27503,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__27737 = (i__27502 + (1));
i__27502 = G__27737;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27503),datascript$impl$entity$js_seq_$_iter__27500(cljs.core.chunk_rest(s__27501__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27503),null);
}
} else {
var vec__27512 = cljs.core.first(s__27501__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27512,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27512,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__27500(cljs.core.rest(s__27501__$2)));
}
} else {
return null;
}
...
var G__27750 = null;
var G__27750__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__27534 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__27535 = null;
var count__27536 = (0);
var i__27537 = (0);
while(true){
if((i__27537 < count__27536)){
var vec__27547 = chunk__27535.cljs$core$IIndexed$_nth$arity$2(null,i__27537);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27547,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27547,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__27752 = seq__27534;
var G__27753 = chunk__27535;
var G__27754 = count__27536;
var G__27755 = (i__27537 + (1));
seq__27534 = G__27752;
chunk__27535 = G__27753;
count__27536 = G__27754;
i__27537 = G__27755;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__27534);
if(temp__5825__auto__){
var seq__27534__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__27534__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__27534__$1);
var G__27758 = cljs.core.chunk_rest(seq__27534__$1);
var G__27759 = c__5548__auto__;
var G__27760 = cljs.core.count(c__5548__auto__);
var G__27761 = (0);
seq__27534 = G__27758;
chunk__27535 = G__27759;
count__27536 = G__27760;
i__27537 = G__27761;
continue;
} else {
var vec__27551 = cljs.core.first(seq__27534__$1);
...
var G__27762 = cljs.core.next(seq__27534__$1);
var G__27763 = null;
var G__27764 = (0);
var G__27765 = (0);
seq__27534 = G__27762;
chunk__27535 = G__27763;
count__27536 = G__27764;
i__27537 = G__27765;
continue;
}
} else {
...
var G__27750__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__27558 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__27559 = null;
var count__27560 = (0);
var i__27561 = (0);
while(true){
if((i__27561 < count__27560)){
var vec__27573 = chunk__27559.cljs$core$IIndexed$_nth$arity$2(null,i__27561);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27573,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27573,(1),null);
f.call(use_as_this,v,a,this$);


var G__27766 = seq__27558;
var G__27767 = chunk__27559;
var G__27768 = count__27560;
var G__27769 = (i__27561 + (1));
seq__27558 = G__27766;
chunk__27559 = G__27767;
count__27560 = G__27768;
i__27561 = G__27769;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__27558);
if(temp__5825__auto__){
var seq__27558__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__27558__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__27558__$1);
var G__27770 = cljs.core.chunk_rest(seq__27558__$1);
var G__27771 = c__5548__auto__;
var G__27772 = cljs.core.count(c__5548__auto__);
var G__27773 = (0);
seq__27558 = G__27770;
chunk__27559 = G__27771;
count__27560 = G__27772;
i__27561 = G__27773;
continue;
} else {
var vec__27592 = cljs.core.first(seq__27558__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27592,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27592,(1),null);
f.call(use_as_this,v,a,this$);


var G__27774 = cljs.core.next(seq__27558__$1);
var G__27775 = null;
var G__27776 = (0);
var G__27777 = (0);
seq__27558 = G__27774;
chunk__27559 = G__27775;
count__27560 = G__27776;
i__27561 = G__27777;
continue;
}
} else {
...
G__27750 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__27750__1.call(this,f);
case 2:
return G__27750__2.call(this,f,use_as_this);
}
...
var G__27598 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__27598);
} else {
return G__27598;
}
}
...
var self__ = this;
var self__ = this;
var G__27636 = (arguments.length - (1));
switch (G__27636) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args27520){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args27520)));
}));
...
var temp__5827__auto__ = (function (){var fexpr__27666 = cljs.core.deref(this$.cache);
return (fexpr__27666.cljs$core$IFn$_invoke$arity$1 ? fexpr__27666.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__27666.call(null,attr));
})();
...
var temp__5825__auto___27792 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5825__auto___27792)){
var datoms_27793 = temp__5825__auto___27792;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_27793)));
