...
var o24896 = temp__5823__auto__;
var temp__5823__auto____$1 = (o24896["core"]);
if(cljs.core.truth_(temp__5823__auto____$1)){
var o24897 = temp__5823__auto____$1;
return (o24897["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22328__auto__ = f;
return (o__22328__auto__["toString"]).call(o__22328__auto__);
} else {
return "";
}
}catch (e24899){var _ = e24899;
return "";
}});
...
try{var o__22328__auto___25300 = t;
(o__22328__auto___25300["cljs$lang$ctorPrWriter"]).call(o__22328__auto___25300,t,writer);
}catch (e24901){var __25301 = e24901;
}
...
var char_code = (function (){var o__22328__auto__ = (new String(char$));
return (o__22328__auto__["charCodeAt"]).call(o__22328__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22328__auto__ = String;
return (o__22328__auto__["fromCharCode"]).call(o__22328__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24918 = num_code;
switch (G__24918) {
case (1):
return (185);
...
var o__22328__auto__ = String;
return (o__22328__auto__["fromCharCode"]).call(o__22328__auto__,superscript_code);
});
/**
...
}catch (e24936){var _e__22340__auto__ = e24936;
return false;
}})())){
...
var vec__24937 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24937,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24989){
var vec__24990 = p__24989;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24990,(0),null);
...
var G__25306 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__25307 = cljs.core.butlast(remaining_tokens);
name_tokens = G__25306;
remaining_tokens = G__25307;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24982){
...
var vec__25008 = cljs.core.split_with((function (p1__25007_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__25007_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25008,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25008,(1),null);
...
var vec__25014 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25014,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25014,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__25309 = cljs.core.rest(remaining_tokens);
var G__25310 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__25309;
name_tokens = G__25310;
continue;
} else {
...
var vec__25032 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25032,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25032,(1),null);
var vec__25035 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25035,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25035,(1),null);
var vec__25038 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25038,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25038,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25038,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25038,(3),null);
...
var vec__25053 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25053,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25053,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25053,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25053,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25053,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25053,(5),null);
...
if(cljs.core.truth_(temp__5823__auto__)){
var vec__25056 = temp__5823__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25056,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25056,(1),null);
var vec__25059 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25059,(0),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__25062 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__25062) : devtools.munging.parse_fn_info_deep.call(null,G__25062));
})()));
}
} else {
return fn_info;
...
var G__25313 = (arity + (1));
var G__25314 = (function (){var temp__5823__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5823__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25063){
var vec__25064 = p__25063;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25064,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25064,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25068_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__25068_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25069_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__25069_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25072){
var vec__25073 = p__25072;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25073,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25070){
...
var map__25110 = options;
var map__25110__$1 = cljs.core.__destructure_map(map__25110);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25110__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25110__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25110__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25110__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25111 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25111,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25111,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25111,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25111,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25111,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25111,(5),null);
...
var o__22328__auto__ = f;
return (o__22328__auto__["getBasis"]).call(o__22328__auto__);
});
/**
...
}catch (e25150){var _e__22340__auto__ = e25150;
...
var G__25325 = (obj[cljs.core.first(path)]);
var G__25326 = cljs.core.rest(path);
obj = G__25325;
path = G__25326;
continue;
} else {
...
var _STAR_ = (function (accum,p__25273){
var vec__25274 = p__25273;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25274,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25274,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25283){
var vec__25288 = p__25283;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25288,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25288,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25288,(2),null);
...
var post_process = (function (p__25296){
var vec__25297 = p__25296;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25297,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25297,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25295_SHARP_){
return (obj[cljs.core.first(p1__25295_SHARP_)]);
}),sorted_matches);
