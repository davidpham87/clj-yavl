...
var G__26719 = db;
var G__26719__$1 = ((cljs.core.not(user_input_exists_QMARK_))?cljs.core.assoc_in(G__26719,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"vega-lite","vega-lite",-650304770)], null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"saved-configs","saved-configs",1634320315),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("clj-yavl.core","data-input","clj-yavl.core/data-input",611355071),"",new cljs.core.Keyword("clj-yavl.core","config-input","clj-yavl.core/config-input",1110176655),clj_yavl.core.default_config_json,new cljs.core.Keyword("clj-yavl.core","config-mode","clj-yavl.core/config-mode",-1919291340),new cljs.core.Keyword(null,"json","json",1279968570),new cljs.core.Keyword("clj-yavl.core","active-config-name","clj-yavl.core/active-config-name",-1939900428),null], null)], null)):G__26719);
var G__26719__$2 = ((cljs.core.not(component_state_exists_QMARK_))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26719__$1,new cljs.core.Keyword("clj-yavl.core","vega-lite","clj-yavl.core/vega-lite",943809627),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword("clj-yavl.core","format","clj-yavl.core/format",1360929541),new cljs.core.Keyword(null,"csv","csv",-1164440893),new cljs.core.Keyword("clj-yavl.core","structure","clj-yavl.core/structure",-30773006),new cljs.core.Keyword(null,"columnar","columnar",-1122999701),new cljs.core.Keyword("clj-yavl.core","parsed-data","clj-yavl.core/parsed-data",-1560578265),null,new cljs.core.Keyword("clj-yavl.core","inferred-schema","clj-yavl.core/inferred-schema",-1109150020),null,new cljs.core.Keyword("clj-yavl.core","active-left-tab","clj-yavl.core/active-left-tab",1685289502),new cljs.core.Keyword(null,"config","config",994861415)], null)):G__26719__$1);
if(cljs.core.not(unit_specs_exists_QMARK_)){
return cljs.core.assoc_in(G__26719__$2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-input","user-input",-504242422),new cljs.core.Keyword(null,"unit-specs","unit-specs",-530655085)], null),cljs.core.PersistentArrayMap.EMPTY);
} else {
return G__26719__$2;
}
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.core","init-unit-spec","clj-yavl.core/init-unit-spec",1162580207),(function (db,p__26720){
var vec__26721 = p__26720;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26721,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26721,(1),null);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26721,(2),null);
var initial_input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26721,(3),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.core","remove-unit-spec","clj-yavl.core/remove-unit-spec",1592748458),(function (db,p__26724){
var vec__26725 = p__26724;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26725,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26725,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.core","update-unit-spec-input","clj-yavl.core/update-unit-spec-input",-399356259),(function (db,p__26729){
var vec__26730 = p__26729;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26730,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26730,(1),null);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26730,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26730,(3),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.core","set-unit-spec-input","clj-yavl.core/set-unit-spec-input",-1334878341),(function (db,p__26734){
var vec__26735 = p__26734;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26735,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26735,(1),null);
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26735,(2),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("clj-yavl.core","unit-spec","clj-yavl.core/unit-spec",1025140806),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__26738){
var vec__26739 = p__26738;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26739,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26739,(1),null);
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("clj-yavl.core","compiled-unit-spec","clj-yavl.core/compiled-unit-spec",1828988733),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p__26742){
var vec__26743 = p__26742;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26743,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26743,(1),null);
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26746__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26746__$1,new cljs.core.Keyword(null,"input","input",556931961));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.core","set-config-input","clj-yavl.core/set-config-input",-1452929027),(function (db,p__26753){
var vec__26754 = p__26753;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26754,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26754,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("clj-yavl.core","set-config-mode","clj-yavl.core/set-config-mode",1485068687),(function (db,p__26757){
var vec__26758 = p__26757;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26758,(0),null);
var new_mode = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26758,(1),null);
...
var _STAR_print_newline_STAR__orig_val__26762_26771 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__26763_26772 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__26764_26773 = true;
var _STAR_print_fn_STAR__temp_val__26765_26774 = (function (x__5671__auto__){
return sb__5670__auto__.append(x__5671__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__26764_26773);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__26765_26774);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(edn_data);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__26763_26772);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__26762_26771);
}
...
}catch (e26769){if((e26769 instanceof Error)){
var ___$1 = e26769;
return current_input;
} else {
throw e26769;
