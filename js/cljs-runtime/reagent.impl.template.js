...
var G__26192 = o;
reagent.impl.template.goog$module$goog$object.set(G__26192,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__26210__delegate = function (args){
...
while (G__26211__i < G__26211__a.length) {G__26211__a[G__26211__i] = arguments[G__26211__i + 0]; ++G__26211__i;}
  args = new cljs.core.IndexedSeq(G__26211__a,0,null);
} 
return G__26210__delegate.call(this,args);};
G__26210.cljs$lang$maxFixedArity = 0;
G__26210.cljs$lang$applyTo = (function (arglist__26212){
var args = cljs.core.seq(arglist__26212);
return G__26210__delegate(args);
});
...
var G__26193 = o;
reagent.impl.template.goog$module$goog$object.set(G__26193,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__26214__i < G__26214__a.length) {G__26214__a[G__26214__i] = arguments[G__26214__i + 0]; ++G__26214__i;}
  args = new cljs.core.IndexedSeq(G__26214__a,0,null);
} 
...
var G__26194 = props;
var G__26194__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26194,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26194);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26194__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26195 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26195,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26195;
}
})(),id_class);
...
var temp__5825__auto___26216 = (function (){var and__5023__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___26216)){
var d_26217 = temp__5825__auto___26216;
if((d_26217 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_26217.s}));
} else {
...
var G__26196 = (cljs.core.count(argv) - first_child);
switch (G__26196) {
case (0):
...
var vec__26197 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26197,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26197,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26197,(2),null);
...
var temp__5829__auto___26219 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___26219 == null)){
} else {
var key_26220 = temp__5829__auto___26219;
...
var temp__5829__auto___26221 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___26221 == null)){
} else {
var key_26222 = temp__5829__auto___26221;
(jsprops.key = key_26222);
}
...
var temp__5829__auto___26223 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___26223 == null)){
} else {
var key_26224 = temp__5829__auto___26223;
(jsprops.key = key_26224);
}
...
var temp__5829__auto___26225 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___26225 == null)){
} else {
var key_26226 = temp__5829__auto___26225;
(jsprops.key = key_26226);
}
...
var temp__5829__auto___26228 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___26228 == null)){
} else {
var key_26229 = temp__5829__auto___26228;
(jsprops.key = key_26229);
}
...
var temp__5829__auto___26230 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___26230 == null)){
} else {
var key_26231 = temp__5829__auto___26230;
(jsprops.key = key_26231);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26200_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26200_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26201 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26201,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26201,(1),null);
...
break;
default:
var G__26233 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26234 = compiler;
v = G__26233;
compiler = G__26234;
continue;
...
var G__26205 = tag;
var G__26205__$1 = (((G__26205 instanceof cljs.core.Keyword))?G__26205.fqn:null);
switch (G__26205__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template26207 = (function (opts,id,fn_to_element,parse_fn,meta26208){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26207.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26209,meta26208__$1){
var self__ = this;
var _26209__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26207(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta26208__$1));
}));

(reagent.impl.template.t_reagent$impl$template26207.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26209){
var self__ = this;
var _26209__$1 = this;
return self__.meta26208;
}));

(reagent.impl.template.t_reagent$impl$template26207.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26207.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26207.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26207.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26207.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26207.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26208","meta26208",1272930469,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26207.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26207.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26207");

(reagent.impl.template.t_reagent$impl$template26207.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template26207");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26207.
 */
reagent.impl.template.__GT_t_reagent$impl$template26207 = (function reagent$impl$template$__GT_t_reagent$impl$template26207(opts,id,fn_to_element,parse_fn,meta26208){
return (new reagent.impl.template.t_reagent$impl$template26207(opts,id,fn_to_element,parse_fn,meta26208));
});
...
return (new reagent.impl.template.t_reagent$impl$template26207(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
