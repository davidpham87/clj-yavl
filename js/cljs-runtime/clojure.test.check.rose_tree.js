...
return cljs.core.cons(cljs.core.first(s),(function (){var G__40174 = (n - (1));
var G__40175 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__40174,G__40175) : clojure.test.check.rose_tree.exclude_nth.call(null,G__40174,G__40175));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__40180 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__40180) : f.call(null,G__40180));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40178_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__40178_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__40178_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40183_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__40183_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__40183_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__40184_SHARP_){
var G__40185 = clojure.test.check.rose_tree.root(p1__40184_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__40185) : pred.call(null,G__40185));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__40186(s__40187){
return (new cljs.core.LazySeq(null,(function (){
var s__40187__$1 = s__40187;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__40187__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__40193 = cljs.core.first(xs__6385__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40193,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40193,(1),null);
var iterys__5499__auto__ = ((function (s__40187__$1,vec__40193,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__40186_$_iter__40188(s__40189){
return (new cljs.core.LazySeq(null,((function (s__40187__$1,vec__40193,rose,index,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__40189__$1 = s__40189;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__40189__$1);
if(temp__5825__auto____$1){
var s__40189__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__40189__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__40189__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__40191 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__40190 = (0);
while(true){
if((i__40190 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__40190);
cljs.core.chunk_append(b__40191,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__40216 = (i__40190 + (1));
i__40190 = G__40216;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40191),clojure$test$check$rose_tree$permutations_$_iter__40186_$_iter__40188(cljs.core.chunk_rest(s__40189__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40191),null);
}
} else {
var child = cljs.core.first(s__40189__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__40186_$_iter__40188(cljs.core.rest(s__40189__$2)));
}
} else {
return null;
}
...
});})(s__40187__$1,vec__40193,rose,index,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__40187__$1,vec__40193,rose,index,xs__6385__auto__,temp__5825__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__40186(cljs.core.rest(s__40187__$1)));
} else {
var G__40218 = cljs.core.rest(s__40187__$1);
s__40187__$1 = G__40218;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40196_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__40196_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__40196_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40200_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__40200_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__40200_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__40202 = f;
var G__40203 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__40202,G__40203) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__40202,G__40203));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__40204 = f;
var G__40205 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__40204,G__40205) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__40204,G__40205));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
