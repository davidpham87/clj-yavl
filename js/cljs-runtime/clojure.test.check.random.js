...
var clojure$test$check$random$IRandom$rand_long$dyn_40220 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_40220(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_40221 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_40221(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_40223 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_40223(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_40225 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_40225(rng,n);
}
});
...
var G__40198 = z;
if(((24) > (function (){var G__40199 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__40199) : clojure.test.check.random.longs.bit_count.call(null,G__40199));
})())){
return clojure.test.check.random.longs.bit_xor(G__40198,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__40198;
}
});
...
var G__40239 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__40240 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__40239;
ret = G__40240;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__40209){
var map__40212 = p__40209;
var map__40212__$1 = cljs.core.__destructure_map(map__40212);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40212__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__40213 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40213,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40213,(1),null);
